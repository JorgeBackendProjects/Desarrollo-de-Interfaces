...
public class Ejercicio_3 extends javax.swing.JFrame {
    ...
    public void ejercicio3(){
        ...
        panelAmarillo.setAlignmentY(TOP_ALIGNMENT);
        ...
        panelMorado.setAlignmentY(BOTTOM_ALIGNMENT);
        ...
        botonAzul.setPreferredSize(new Dimension(200, 50));
        botonAzul.setAlignmentX(CENTER_ALIGNMENT);
        
        botonRojo = new JButton();
        botonRojo.setBackground(Color.red);
        botonRojo.setText("Boton Rojo");
        botonRojo.setVisible(true);
        botonRojo.setPreferredSize(new Dimension(200, 50));
        botonRojo.setAlignmentX(CENTER_ALIGNMENT);
        
        botonVerde = new JButton();
        botonVerde.setBackground(Color.green);
        botonVerde.setText("Boton Verde");
        botonVerde.setVisible(true);
        botonVerde.setPreferredSize(new Dimension(200, 50));
        botonVerde.setAlignmentX(CENTER_ALIGNMENT);
        
        this.add(panelAmarillo);
        this.add(botonAzul);
        this.add(botonRojo);
        this.add(botonVerde);
        this.add(panelMorado);
